...
export class ToolBurstChipComponent {
  ...
  // Written-out meaning of the current row's glyph, e.g. "Read - Files read".
  // Used in the expanded detail head so the emoji glyph is
...
const GLYPH_LEGEND: readonly GlyphLegendEntry[] = [
  ...
  { glyph: '💻', name: 'Shell', meaning: 'Command executed' },
