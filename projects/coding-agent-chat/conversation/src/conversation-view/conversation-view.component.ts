...
export class ConversationViewComponent {
  ...
  /**
   * Highlight only typed source payloads. A null result keeps the template on
   * text interpolation, preserving the readable fallback for raw logs,
   * unknown languages, and payloads over the shared highlighter size guard.
   */
