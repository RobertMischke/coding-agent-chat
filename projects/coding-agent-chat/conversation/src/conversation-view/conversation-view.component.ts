...
export class ConversationViewComponent {
  ...
  /**
   * Produces escaped, class-based highlight markup for typed source payloads.
   * Angular sanitises the template's `innerHTML` binding; null keeps the
   * existing readable text interpolation for raw logs and highlight fallbacks.
   */
