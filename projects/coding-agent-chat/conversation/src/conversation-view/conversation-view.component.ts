...
export class ConversationViewComponent {
  ...
  /** Render typed source payloads through the shared Markdown highlight engine. */
  protected payloadHighlight(payload: MessageContentPayload): HighlightPayloadResult {
    switch (payload.type) {
      case 'code-block':
