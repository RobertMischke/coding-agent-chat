...
export class ConversationViewComponent {
  ...
  /**
   * Highlight typed source payloads through the Markdown entry point's shared
   * engine. A null result deliberately keeps the template on text
   * interpolation so unknown languages and oversized payloads remain literal.
   */
