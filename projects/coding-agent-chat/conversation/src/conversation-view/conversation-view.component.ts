...
export class ConversationViewComponent {
  ...
  /**
   * Return sanitizer-safe highlighting for supported typed payloads. A null
   * result preserves the existing plain-text rendering for unknown languages,
   * oversized content, and raw logs.
   */
