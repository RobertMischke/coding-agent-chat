...
describe('highlightPayload', () => {
  it('maps typed payloads to the existing grammars', () => {
    ...
    const highlighted = highlightPayload(diff, 'diff');
  ...
  it('returns null for unknown grammars and payloads above the shared size guard', () => {
