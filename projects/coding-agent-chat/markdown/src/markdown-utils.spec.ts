...
describe('highlightPayload', () => {
  it('maps typed payloads to the shared grammars and balances every source line', () => {
    const diff = [
  ...
  it('returns null for an unknown grammar or a payload over the shared size guard', () => {
