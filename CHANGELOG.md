...
- Typed code, diff, JSON, and HTML-file payloads now reuse the Markdown
  highlighter in the conversation view, including line-level addition,
  deletion, and hunk styling for visual diffs.
