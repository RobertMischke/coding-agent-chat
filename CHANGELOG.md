...
- Typed C#, diff, JSON, and HTML-file payloads in the conversation view now
  reuse the Markdown highlighter, including line-level addition, deletion, and
  hunk-header styling for visual diffs.
