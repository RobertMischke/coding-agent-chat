...
- Typed `code-block`, `diff`, `json`, and `html-file` payloads in the
  conversation view now reuse the Markdown syntax highlighter, including
  line-level addition, deletion, and hunk-header styling for visual diffs.
