...
[0.4.1](https://www.npmjs.com/package/coding-agent-chat/v/0.4.1).
...
- Typed code, diff, JSON, and HTML payloads in the conversation view now reuse
  the Markdown highlighter, including syntax tokens and line-level visual diff
  coloring, while unsupported or oversized payloads remain readable plain text.
