...
- Typed C#, JSON, HTML, and other source payloads in the conversation view now
  reuse the Markdown highlighter, and git diffs distinguish additions,
  deletions, and hunk headers with line-level syntax classes and tints.
