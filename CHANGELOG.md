...
- Typed code, diff, JSON, and HTML-file payloads in the conversation view now
  reuse the Markdown highlighter, including syntax tokens and line-level visual
  diff coloring, while guarded or unknown content remains readable plain text.
